...
class MatriceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('matrice.index',compact('matrices'));
    }
    ...
    public function create()
    {
        ...
        return view ('matrice.add',compact('appels','employes'));
    }
    ...
    public function show($id)
    {
        ...
        return view('matrice.show',compact('matrice'));
    }
    ...
    public function edit($id)
    {
        ...
        $appels = $this->appelRepository->getAll();
        $employes = $this->employeRepository->getAll();
        return view('matrice.edit',compact('matrice','appels','employes'));
    }
